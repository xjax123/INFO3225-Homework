...
public void setupShapes() {
    ...
    chair2BackWide.translate(0,-22.5f,-15);
    ...
    chair2Top.translate(0,-62.5f,-15);
    //Seat
...
public void mouseDragged(MouseEvent event) {
    ...
    if (mouseButton == RIGHT) {
        camRotY += newX*0.5f;
        camRotX -= newY*0.5f;
        float testrot = camRotX-newX*0.5f;
        if (testrot > 170) {
            camRotX = 170;
        } else if (testrot < 10) {
            camRotX = 10;
...
public PShape genCylinder(int sides, float r1, float r2, float h)
{
...
public PShape genHex(PVector b1, PVector b2, PVector b3, PVector b4, PVector t1, PVector t2, PVector t3, PVector t4) {
...
public void generateGrass(float ammount, PShape parent, float areaX, float areaZ, PVector offset) {
    ...
    for (int x = 0; x < ammount; x++) {
        ...
        PShape grassTop = genHex(new PVector(width*0.5f,0,-0.5f),new PVector(width*0.5f,0,0.5f),new PVector(-width*0.5f,0,0.5f),new PVector(-width*0.5f,0,-0.5f),new PVector(width*0.2f,-3,1),new PVector(width*0.2f,-3,1.5f),new PVector(-width*0.2f,-3,1.5f),new PVector(-width*0.2f,-3,1));
        grassTop.translate(0,-height*0.5f,0);
        ...
        grassBlade.translate(-areaX*0.5f,0,-areaZ*0.5f);
...
public void genTree(PShape parent, float trunkHeight, float trunkWidth, float leavesAmmount, float leafAreaX, float leafAreaY, float leafAreaZ, PVector position) {
    PShape treeMain = createShape(GROUP);
    fill(0xFF55342B);
    PShape trunk = genCylinder(20,trunkWidth,trunkWidth,trunkHeight);
    trunk.rotateX(radians(90));
    trunk.translate(0,-trunkHeight*0.5f,0);
    treeMain.addChild(trunk);

    int[] colors = {0xFF608F07,0xFF6F9F05,0xFF84AE09,0xFF91B90C,0xFFA6C70D};
    ...
    leaves.translate(-leafAreaX*0.5f,-leafAreaY*0.8f,-leafAreaZ*0.5f);
...
class SpotLight extends Light {
  ...
  public void settings() { size(1920, 1061, P3D); }
